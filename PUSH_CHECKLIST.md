...
```bash
curl -fsSL https://raw.githubusercontent.com/HyphaeAI/HiveTerminal/master/install.sh
```

### Test Windows Installer
```powershell
irm https://raw.githubusercontent.com/HyphaeAI/HiveTerminal/master/install.ps1
```
